...
purchase_data = pd.read_csv(r'C:\Users\utkarssh sehgal\Desktop\QVI_purchase_behaviour.csv')
transaction_data = pd.read_csv(r'C:\Users\utkarssh sehgal\Desktop\QVI_transaction_data.csv')
...
# Save merged_data DataFrame to an Excel file
merged_data.to_excel(r'C:\Users\utkarssh sehgal\Desktop\merged_data.xlsx', index=False)
